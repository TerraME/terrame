...
local id7 = ID("maketoolbar.makemenu7")
...
return {
	...
	onRegister = function(self)
		...
		menu:AppendSeparator()
		menu:Append(id2, "Create Projects\tCtrl-Shift-P")
		menu:Append(id3, "Documentation Sketch\tCtrl-Shift-S")
		menu:Append(id4, "Build Documentation\tCtrl-Shift-D")
		menu:Append(id5, "View Documentation\tCtrl-Shift-V")
		menu:Append(id6, "Run tests\tCtrl-Shift-T")
		menu:Append(id7, "Check package\tCtrl-Shift-C")
		...
		myConnect(id1)
		myConnect(id2, "projects")
		myConnect(id3, "sketch")
		myConnect(id4, "doc")
		myConnect(id5, "showdoc")
		myConnect(id6, "test")
		myConnect(id7, "check")
	...
	onUnRegister = function(self)
		...
		ide:RemoveMenuItem(id6)
		ide:RemoveMenuItem(id7)
